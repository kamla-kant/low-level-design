...
public class Main {
    public static void main(String[] args) {
        ...
        List<ParkingSpot> parkingSpotsFloor1 = List.of(
                ParkingSpotFactory.createParkingSpots(ParkingSpotType.BIKE, 101),
                ParkingSpotFactory.createParkingSpots(ParkingSpotType.COMPACT, 102),
                ParkingSpotFactory.createParkingSpots(ParkingSpotType.LARGE, 103)
        );

        List<ParkingSpot> parkingSpotsFloor2 = List.of(
                ParkingSpotFactory.createParkingSpots(ParkingSpotType.BIKE, 201),
                ParkingSpotFactory.createParkingSpots(ParkingSpotType.COMPACT, 202)
        );
